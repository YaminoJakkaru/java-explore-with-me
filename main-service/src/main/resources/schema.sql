...
(
    ...
    CONSTRAINT fk_commment FOREIGN KEY (comment_id) REFERENCES comment ON DELETE CASCADE,
    CONSTRAINT fk_responder FOREIGN KEY (responder_id) REFERENCES users ON DELETE CASCADE,
    CONSTRAINT uq_comment_reaction UNIQUE (comment_id, responder_id)
    );
